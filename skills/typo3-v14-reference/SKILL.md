...
description: "TYPO3 v14 API reference for writing v14 code: controllers, ViewFactory, Fluid, PSR-14 events, backend modules, TCA, QueryBuilder, CLI commands and tests. Use when the user asks what a v14 API looks like, which event replaced a hook, or how to write a specific piece of v14 code. Does NOT run upgrades: for a whole project or site upgrade use typo3-upgrade-run, which owns the version constraints, the PHP target and the migration process."
