...
plugin-enabled reproducible `composer install` and regenerate the autoloader. TYPO3's extension
registry is generated by Composer integration and may be absent even though the lock and vendor tree
exist. Never hand-create or patch that file in `vendor/`; rerun Fractor after regeneration.
